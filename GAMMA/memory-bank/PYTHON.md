---
description: Python Coding Guidelines for GAMMA Project
globs: *.py,pyproject.toml
alwaysApply: false
---
# Python Coding Guidelines for GAMMA Project

These are rules for the GAMMA project - a modern FastAPI backend for WhatsApp PM System v3.0 using uv.
...
## GAMMA Project Specific Rules

### FastAPI and Async Patterns
- Always use async/await patterns for database operations and external API calls
- Use proper dependency injection with FastAPI's Depends()
- Implement proper error handling with HTTPException
- Use Pydantic models for request/response validation
- Implement proper CORS, authentication, and tenant middleware

### Database and SQLAlchemy
- Use SQLAlchemy 2.0 style with async sessions
- Always use proper transaction management with async context managers
- Implement proper relationship loading (selectinload, joinedload) to avoid N+1 queries
- Use proper indexing and constraints in database models
- Implement tenant isolation at the database level

### Service Layer Architecture
- Keep business logic in service classes, not in routers
- Use dependency injection for services
- Implement proper error handling and logging in services
- Use background tasks for non-blocking operations

### Security and Authentication
- Always validate user permissions and tenant access
- Implement proper JWT token handling
- Use secure password hashing
- Implement rate limiting and input validation

### WhatsApp Integration
- Handle WhatsApp webhook payloads properly
...
## GAMMA Project Architecture Notes

### Multi-Tenant Architecture
- Always consider tenant isolation in database queries
- Use tenant middleware for request context
- Implement proper tenant-based access control
- Handle tenant-specific configurations

### CPM and Project Management Features
- Implement proper task dependency management
- Use critical path calculations for scheduling
- Handle resource leveling and optimization
- Implement earned value management metrics

### WhatsApp Integration
- Handle webhook security and validation
- Implement proper message queuing
- Use background tasks for message processing
- Handle rate limits and error recovery

### Advanced Features (Week 4)
- Baseline management for project tracking
